...
describe('ValidateFormMessageAction', () => {
  it('should create an instance', () => {
    expect(new ValidateNotificationAction(null)).toBeTruthy();
  });
  ...
  it('should contain invalid NotifierType', () => {
    const logger: LoggingService = TestBed.get(LoggingService);
    const notification = new Notification('The Title', 'A description for the notification.', null);
    notification.messages.push('Email is not valid.');
  ...
  it('should execute using the BusinessProvider', inject([BusinessProviderService], (businessProvider: BusinessProviderService) => {
    const notification = new Notification('ApplicationName', 'A description for the notification.', NotifierType.Banner);
    notification.messages.push('Email is not valid.');
